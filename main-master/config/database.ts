  ...
  connections: {
    ...
    */
    tenants: {
      client: "pg",
      connection: {
        host: Env.get("DB_HOST", "127.0.1.1") as string,
        port: Number(Env.get("DB_PORT", 5432)),
        user: Env.get("DB_USER", "tenants") as string,
        password: Env.get("DB_PASSWORD", "tenants") as string,
        database: Env.get("DB_NAME", "tenants") as string,
      },
      pool: {
        min: 20,
        max: 100,
    ...
    primary: {
      ...
      connection: {
        ...
        user: Env.get("DB_USER", "tenants") as string,
        password: Env.get("DB_PASSWORD", "tenants") as string,
        database: Env.get("DB_NAME", "primary") as string,
      },
      pool: {
        min: 20,
        max: 100,
