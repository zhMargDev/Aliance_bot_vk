...
const redis = {
  host: Env.get('REDIS_HOST_NAU_UNANSWERED'),
...
const bullNauUnanswered = new Bull('my_queue_nau_un', { redis, defaultJobOptions, settings, limiter })

module.exports = { bullNauUnanswered }
